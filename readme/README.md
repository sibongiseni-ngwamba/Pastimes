# 🛍️ PASTIMES - Pre-Loved Fashion Marketplace
...
- 🛍️ Session-based shopping cart with quantity updates and persistence
...
- 🛠️ Admin user, listing, order, and messaging management
...
- ⚙️ Admin: `admin@pastimes.co.za` / `12345678`
...
- 🖼️ Product image uploads are saved under `assets/images/uploads/`.
